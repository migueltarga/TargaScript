...
func TestFunctionObject(t *testing.T) {
	...
	// The body format in the AST includes the curly braces and spaces
	expectedBody := "{ (x + 2) }"
...
func TestPrintStatement(t *testing.T) {
	// When using print as a statement, it prints the value
	// and returns NULL, not the value itself
	tests := []struct {
		input    string
		expected interface{}
	}{
